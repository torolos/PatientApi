...
namespace PatientApi.src.Filters
{
    public class TokenIntrospectionFilterDistributedCache : IAsyncAuthorizationFilter
    {
        ...
        public TokenIntrospectionFilterDistributedCache(IHttpClientFactory httpClientFactory, ILogger<TokenIntrospectionFilter> logger, IDistributedCache cache)
        {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            {
                var claims = JsonSerializer.Deserialize<List<Claim>>(cached);
            ...
            try
            {
                ...
                await _cache.SetStringAsync(token, serializedClaims, options);
